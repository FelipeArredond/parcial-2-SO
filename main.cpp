...
int main(int argc, char* argv[]) {
    ...
    std::string archivo_salida = (argc == 3) ? argv[2] : "imagen_procesada2.jpg";
    ...
    openCV_manager opencv_manager = openCV_manager(archivo_entrada);

    opencv_manager.convert_gray_image();
    opencv_manager.detect_faces();
